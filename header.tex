...
\lstdefinelanguage{MGL}{
  sensitive = true,
  otherkeywords={},
  keywords = [1]{enum, for, import, entity, path, id, stylePath, graphModel, iconPath, diagramExtension, containableElements, attr, EString, EInt, as, style, extends, node, incomingEdges, outgoingEdges, container, edge},
  frame=tb,
  framesep=0.7em,
  %framextopmargin=5em,
  numbers=left,
