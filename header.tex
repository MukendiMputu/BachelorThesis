...
\lstdefinelanguage{MGL}{
  sensitive = true,
  otherkeywords={},
  keywords = [1]{enum, for, import, entity, path, id, stylePath, graphModel, iconPath, diagramExtension, containableElements, attr, EString, EInt, as, style, node, incomingEdges, outgoingEdges, },
  frame=none, 
